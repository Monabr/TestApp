...
import com.example.testapp.material.BottomSheetNavigator.Destination
...
@Composable
fun rememberBottomSheetNavigatorCustom(): BottomSheetNavigator {
...
/**
 * The state of a [ModalBottomSheetLayoutCustom] that the [BottomSheetNavigator] drives
 *
...
/**
 * Navigator that drives a [ModalBottomSheetState] for use of [ModalBottomSheetLayoutCustom]s
...
class BottomSheetNavigator(
    ...
    /**
     * Access properties of the [ModalBottomSheetLayoutCustom]'s [ModalBottomSheetState]
     */
     ...
     * sheetContent of your [ModalBottomSheetLayoutCustom].
     */
    val sheetContent: @Composable ColumnScope.() -> Unit = {
        ...
        if (retainedEntry != null && retainedEntry?.lifecycle?.currentState != Lifecycle.State.DESTROYED) {
